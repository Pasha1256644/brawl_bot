...
async def clean_old_tasks():
    """Удаляет задания старше 48 часов"""
...
async def cmd_start(message: Message, state: FSMContext):
    ...
    # Очищаем старые задания (асинхронно, не блокируем)
...
async def worker_photo_handler(message: Message, state: FSMContext):
    ...
    # Проверяем время с небольшим запасом
    ...
    # Даём паузу, чтобы не нагружать процессор
...
# ============================================
# ===== ОСТАЛЬНЫЕ ХЕНДЛЕРЫ (ПОКУПКА, ВЫВОД) =====
# ============================================
# ... (все остальные хендлеры из предыдущей версии бота)
...
async def main():
    ...
    print("🔄 Добавлена автоматическая очистка старых заданий (48 часов)")
    print("⚡ Оптимизирована работа с фото (добавлен asyncio.sleep)")
